...
export default function Visitor() {
  ...
  <nav className="flex items-center justify-between flex-wrap p-6">
      ...
      <div className="flex items-center flex-shrink-0 text-dark md:text-right mr-6">
        <span className="font-semibold text-xl tracking-tight hover:text-green-800"><a href="/Home">SHIPSHOP DRIVER PAGE</a></span>
      </div>
    ...
    <div id="nav-content" className="w-full flex-grow lg:flex lg:items-center lg:w-auto hidden lg:block pt-6 lg:pt-0 md:text-right">
      <div className="text-sm lg:flex-grow">
          <a href="/Visitor" className="block mt-1 lg:inline-block lg:mt-0 text-dark-200 hover:text-teal-800 mr-4">Home</a>
          ...
          <a href="/Driver" className="block mt-4 lg:inline-block lg:mt-0 text-dark-200 hover:text-teal-800 mr-4">Driver</a>
